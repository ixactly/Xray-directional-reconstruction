...
int main() {
    ...
    XTT::reconstruct(sinogram, ct, md, geom, 2, 30, Rotate::CW, Method::MLEM, 9e-3);
    // XTT::orthReconstruct(sinogram, ct, md, geom, 3, 5, 30, Rotate::CW, Method::MLEM, 9e-3);
    // IR::reconstruct(sinogram, ct, geom, 20, 30, Rotate::CW, Method::ART, 5e-2);
    ...
    for (int i = 0; i < NUM_BASIS_VECTOR; i++) {
        std::string savefilePathCT =
                ...
                // "../volume_bin/gfrp_a/sc_ir_art" + std::to_string(i + 1) + "_" +
